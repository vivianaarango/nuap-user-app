namespace nuap.ViewModels
{
    ...
    public class SalesDetailViewModel:BaseViewModel
    {
        ...
        {
            get { return this.deliveryAmount; }
            set { SetValue(ref this.deliveryAmount, value); }
        }

        public string DiscountAmount
        {
            get { return this.discountAmount; }
            set { SetValue(ref this.discountAmount, value); }
        }
        ...
        public SalesDetailViewModel(Order order)
        {
            this.Order = order;
        ...
        private async void UpdateStatus()
        {
            var mainViewModel = MainViewModel.GetInstance();
            mainViewModel.OrderID = this.Order.Id;
            mainViewModel.OrderStatus = this.Order.Status;
            mainViewModel.OrderAddress = this.Order.Address;
            mainViewModel.UpdateOrderStatus = new UpdateOrderStatusViewModel();
            await Application.Current.MainPage.Navigation.PushAsync(new UpdateOrderStatusPage());
        }
        ...
        private void LoadDetailOrder()
        {
            ...
            this.DiscountAmount = this.Order.TotalDiscount;
            this.Subtotal = this.Order.TotalAmount;
